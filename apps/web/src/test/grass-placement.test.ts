...
describe('grass placement model', () => {
  ...
  it('hides water foam on base cells covered by the second layer', () => {
    const baseCells = getGrassShapeCells(grassShapes.nine, { x: 1, y: 1 });

    expect(getVisibleGrassFoamCells({
      baseCells,
      coveredCells: getGrassShapeCells(grassShapes.nine, { x: 1, y: 1 }),
    })).toEqual([]);
    expect(getVisibleGrassFoamCells({
      baseCells,
      coveredCells: [{ x: 2, y: 2 }],
    })).toEqual(getGrassFoamCells(baseCells));
  });
  ...
  it('renders second-layer shadows as square material shadows sized by rock width', () => {
  ...
  it('moves narrow second-layer shadows upward so their visible pixels sit under the rock', () => {
    expect(getSecondLayerShadowRenderOffsetY({ cell: { x: 3, y: 8 }, widthCells: 3 }, 64)).toBe(0);
    expect(getSecondLayerShadowRenderOffsetY({ cell: { x: 2, y: 8 }, widthCells: 1 }, 64)).toBe(-27);
  });
  ...
  it('merges stacked second-layer 3x3 and horizontal 1x3 before choosing outer edges', () => {
    expect(getComparableSecondLayerTerrainPieces({
      ...
      { cell: { x: 2, y: 8 }, frame: 41, surface: 'rock' },
      { cell: { x: 3, y: 8 }, frame: 42, surface: 'rock' },
      { cell: { x: 4, y: 8 }, frame: 43, surface: 'rock' },
      { cell: { x: 2, y: 3 }, frame: 5, surface: 'grass' },
      { cell: { x: 3, y: 3 }, frame: 6, surface: 'grass' },
      { cell: { x: 4, y: 3 }, frame: 7, surface: 'grass' },
      { cell: { x: 2, y: 4 }, frame: 14, surface: 'grass' },
  ...
  it('merges second-layer 3x3 and horizontal 1x3 through the generated front row', () => {
    expect(getComparableSecondLayerTerrainPieces({
      ...
      { cell: { x: 2, y: 9 }, frame: 41, surface: 'rock' },
      { cell: { x: 3, y: 9 }, frame: 42, surface: 'rock' },
      { cell: { x: 4, y: 9 }, frame: 43, surface: 'rock' },
      { cell: { x: 2, y: 3 }, frame: 5, surface: 'grass' },
      { cell: { x: 3, y: 3 }, frame: 6, surface: 'grass' },
      { cell: { x: 4, y: 3 }, frame: 7, surface: 'grass' },
      { cell: { x: 2, y: 4 }, frame: 14, surface: 'grass' },
  ...
  it('merges second-layer vertical 1x3 and 1x1 through the generated front cell', () => {
    expect(getComparableSecondLayerTerrainPieces({
      ...
      { cell: { x: 2, y: 9 }, frame: 44, surface: 'rock' },
      { cell: { x: 2, y: 3 }, frame: 8, surface: 'grass' },
      { cell: { x: 2, y: 4 }, frame: 17, surface: 'grass' },
      { cell: { x: 2, y: 5 }, frame: 17, surface: 'grass' },
      { cell: { x: 2, y: 6 }, frame: 17, surface: 'grass' },
  ...
  it('connects adjacent second-layer cells across separate placements before choosing frames', () => {
    expect(getComparableSecondLayerTerrainPieces({
      ...
      { cell: { x: 2, y: 4 }, frame: 41, surface: 'rock' },
      { cell: { x: 3, y: 4 }, frame: 43, surface: 'rock' },
      { cell: { x: 2, y: 3 }, frame: 32, surface: 'grass' },
  ...
  it('merges separate second-layer placements across generated rock height', () => {
    expect(getComparableSecondLayerTerrainPieces({
      ...
      { cell: { x: 3, y: 7 }, frame: 42, surface: 'rock' },
      { cell: { x: 4, y: 7 }, frame: 43, surface: 'rock' },
      { cell: { x: 2, y: 1 }, frame: 5, surface: 'grass' },
      { cell: { x: 3, y: 1 }, frame: 6, surface: 'grass' },
      { cell: { x: 4, y: 1 }, frame: 7, surface: 'grass' },
      { cell: { x: 2, y: 2 }, frame: 14, surface: 'grass' },
      { cell: { x: 3, y: 2 }, frame: 15, surface: 'grass' },
      { cell: { x: 4, y: 2 }, frame: 16, surface: 'grass' },
