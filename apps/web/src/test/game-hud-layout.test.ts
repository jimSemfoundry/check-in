...
describe('game HUD layout', () => {
  ...
  it('places the numbered terrain tiles into the first four slots', () => {
    ...
    expect(gameHudLayout.getSlotItemTargets(1280)).toEqual([
      ...
      { slotIndex: 1, frame: 28, displayScale: 0.82, target: { x: -66, y: -24, width: 47, height: 47 } },
      { slotIndex: 2, frame: 12, displayScale: 0.82, target: { x: 0, y: -24, width: 47, height: 47 } },
      { slotIndex: 3, frame: 10, displayScale: 0.82, target: { x: 66, y: -24, width: 47, height: 47 } },
    ]);
    expect(gameHudLayout.getSlotItemTargets(320)).toEqual([
      ...
      { slotIndex: 1, frame: 28, displayScale: 0.82, target: { x: -46, y: -24, width: 29, height: 29 } },
      { slotIndex: 2, frame: 12, displayScale: 0.82, target: { x: 0, y: -24, width: 29, height: 29 } },
      { slotIndex: 3, frame: 10, displayScale: 0.82, target: { x: 46, y: -24, width: 29, height: 29 } },
    ]);
  });
